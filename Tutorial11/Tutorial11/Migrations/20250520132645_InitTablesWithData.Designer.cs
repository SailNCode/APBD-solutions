...
namespace Tutorial11.Migrations
{
    ...
    [Migration("20250520132645_InitTablesWithData")]
    partial class InitTablesWithData
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Tutorial5.Models.Medicament", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            IdMedicament = 1,
                            Description = "Doesn't work, but many people like it",
                            Name = "Rutinoscorbin",
                            Type = "Suplement"
                        },
                        new
                        {
                            IdMedicament = 2,
                            Description = "Good for sore throat",
                            Name = "Gagarin",
                            Type = "Suplement"
                        });
                });
            ...
            modelBuilder.Entity("Tutorial5.Models.Patient", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            IdPatient = 2,
                            Birthdate = new DateTime(1955, 2, 12, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            FirstName = "Jarosław",
                            LastName = "Sykson"
                        });
                });
